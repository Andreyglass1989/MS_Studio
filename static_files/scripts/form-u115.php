...
{
	$to = 'daimonsv@rambler.ru';
	$subject = 'Форма Contacts Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U116"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Сообщение:</b></td><td>' . htmlentities($_REQUEST["custom_U127"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Сотовый телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U153"],ENT_COMPAT,'UTF-8') . '</td></tr>';
